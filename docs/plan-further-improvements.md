...
**Status: shipped** (PRs #14–#23, landed on `main` via **#24**). Phases **1–5** in [plan-next-phases.md](plan-next-phases.md) were already shipped. This document is the completed 6–15 slice (trust settings through the microplastics chip). Further work: [plan-after-twenty.md](plan-after-twenty.md).
