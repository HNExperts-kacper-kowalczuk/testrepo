# INCI Scan — App Store (polski)

**Podtytuł (30 znaków)**  
Skaner składu INCI offline

**Tekst promocyjny**  
Sprawdź kod kreskowy albo skład z etykiety bez konta. Oceny zostają w telefonie.

**Opis**

INCI Scan to offline’owy skaner składników kosmetyków.
...
To nie jest wyrób medyczny. Nie zastępuje etykiety, dermatologa ani załączników UE.

**Słowa kluczowe**  
kosmetyki,INCI,skład,kod kreskowy,skaner,pielęgnacja,alergia,offline
