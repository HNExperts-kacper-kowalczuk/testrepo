...
This is the working plan for phases **1–5** (catalog, pack trust, profiles, compare, polish). Those phases are **shipped**. Phases **6–15** in **[plan-further-improvements.md](plan-further-improvements.md)** are also shipped. Next slice: **[plan-after-fifteen.md](plan-after-fifteen.md)**.
