...
This build includes the **shipped CosIng/OBF catalog** (~36k ingredients, ~17k products) and caches online GTIN hits on device. It also includes phases 6–24 UI (usage confirm, shelf formula watch, share image, microplastics and animal-derived chips, catalog notes and changelog, data wipe) and a sticky result rating header.
