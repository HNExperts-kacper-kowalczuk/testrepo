...
The 21–23 slice in [plan-after-twenty.md](docs/plan-after-twenty.md) is shipped. Next after this PR: [phase 26](docs/plan-after-twenty-three.md) (optional in-app theme override).
...
- **[After 21–23: phases 24–26](docs/plan-after-twenty-three.md)** — ruleset changelog (shipped), store copy, optional theme override
